...
public class FoundationAdapter extends RecyclerView.Adapter<FoundationAdapter.FoundationViewHolder> {
    ...
    public FoundationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FoundationViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_foundation_manager, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull FoundationViewHolder holder, int position) {
        ...
        holder.showDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EventBus.getDefault().postSticky(new ManagerFoundationClick(true,model));
            }
        });
    ...
    public class FoundationViewHolder extends RecyclerView.ViewHolder {
        ...
        public FoundationViewHolder(@NonNull View itemView) {
            super(itemView);
            name = itemView.findViewById(R.id.item_foundation_name_manager);
            imageView = itemView.findViewById(R.id.item_foundation_image_manager);
            showDetails = itemView.findViewById(R.id.item_foundation_show_details_manager_btn);
        }
    }
}
